...
- The current package targets DSH Web `0.1.0-rc.8` and compatible later releases. If a future DSH release changes its session or workspace interfaces, install a plugin release that explicitly supports it.
